...
import { StyledDivButtons, StyledMain, StyledLoginButton, StyledRegisterButton, StyledDivSmallImg } from "./style"
...
export const HomePage=()=>{
    ...
    return(
        ...
        <StyledRegisterButton onClick={registerRedirect} >Cadastre-se</StyledRegisterButton>
        <StyledDivSmallImg>
        <img src={africa700}/>
        <img src={asianArt}/>
